...
order_2_primes = [101, 103, 107, 109, 113, 127, 131, 137, 139, 149]

order_3_primes = [1009, 1013, 1019, 1021, 1031, 1033, 1039, 1049, 1051, 1061]
...
order_7_primes = [
    10000019, 10000079, 10000103, 10000121, 10000139, 10000141, 10000169,
    10000189, 10000223, 10000229
]
...
def known_prime_test(length):
    ...
    for order in order_range:
        ...
        print("Order {0}, average time: {1:f}s, number of iterations: {2}".
              format(order, *result))


def fermat_test(n=12):
    for x in range(n):
        print("2^(2^{0}) +1 = 2^{1} + 1 is ".format(x, 2**x),
...
group.add_argument(
    '--medium', help='Test primes up to order 6', action='store_true')
group.add_argument(
    '--long', help='Test primes up to order 7', action='store_true')
group.add_argument(
    '--superlong', help='Test primes up to order 8', action='store_true')
group.add_argument(
    '--stupidlylong', help='Test primes up to order 9', action='store_true')
group.add_argument(
    '--fermat',
    help='Check the primality of the first n Fermat numbers',
    type=int,
    default=0)
